...
const BASE = {
  'en-US': {
    ...
    tabWriting: 'Text to Speech',
    tabSpeaking: 'Voice to Text',
...
BASE['hi-IN'] = {
  ...
  tabWriting: 'पाठ से वाणी',
  tabSpeaking: 'वाणी से पाठ',
...
BASE['gu-IN'] = {
  ...
  tabWriting: 'લખાણ થી વાણી',
  tabSpeaking: 'વાણી થી લખાણ',
...
BASE['es-ES'] = {
  ...
  tabConversation: 'Conversación', tabWriting: 'Texto a Voz', tabSpeaking: 'Voz a Texto', tabSettings: 'Configuración',
...
BASE['fr-FR'] = {
  ...
  tabConversation: 'Conversation', tabWriting: 'Texte à parole', tabSpeaking: 'Parole à texte', tabSettings: 'Paramètres',
...
BASE['zh-CN'] = {
  ...
  tabConversation: '对话', tabWriting: '文字转语音', tabSpeaking: '语音转文字', tabSettings: '设置',
...
BASE['ja-JP'] = {
  ...
  tabConversation: '会話', tabWriting: 'テキスト読み上げ', tabSpeaking: '音声テキスト化', tabSettings: '設定',
...
BASE['ar-SA'] = {
  ...
  tabConversation: 'محادثة', tabWriting: 'نص إلى كلام', tabSpeaking: 'كلام إلى نص', tabSettings: 'الإعدادات',
