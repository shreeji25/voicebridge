...
BASE['es-ES'] = {
  ...
  tabConversation: 'Conversación', tabTextToSpeech: 'Texto a Voz', tabVoiceToText: 'Voz a Texto', tabSettings: 'Configuración',
...
BASE['fr-FR'] = {
  ...
  tabConversation: 'Conversation', tabTextToSpeech: 'Texte à parole', tabVoiceToText: 'Parole à texte', tabSettings: 'Paramètres',
...
BASE['zh-CN'] = {
  ...
  tabConversation: '对话', tabTextToSpeech: '文字转语音', tabVoiceToText: '语音转文字', tabSettings: '设置',
...
BASE['ja-JP'] = {
  ...
  tabConversation: '会話', tabTextToSpeech: 'テキスト読み上げ', tabVoiceToText: '音声テキスト化', tabSettings: '設定',
...
BASE['ar-SA'] = {
  ...
  tabConversation: 'محادثة', tabTextToSpeech: 'نص إلى كلام', tabVoiceToText: 'كلام إلى نص', tabSettings: 'الإعدادات',
